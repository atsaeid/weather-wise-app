...
const Header = () => {
  ...
  return (
    <header className="text-white px-4 py-3 flex justify-between items-center sticky top-0 z-10 bg-gradient-to-b from-blue-900/80 to-transparent backdrop-blur-sm">
      {/* Logo and App Title */}
